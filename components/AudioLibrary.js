...
const AudioLibrary = () => {
  ...
  // Add audio to current section
  const addAudioToSection = (audio) => {
    // Implement this based on your application's needs
    actions.addAudioToSection(audio);
    actions.setNotification({
      type: 'success',
      message: `Audio "${audio.name}" added to section`
    });
  };
            ...
            {Object.values(savedAudios).map((audio) => (
              ...
              >
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    onClick={() => addAudioToSection(audio)}
