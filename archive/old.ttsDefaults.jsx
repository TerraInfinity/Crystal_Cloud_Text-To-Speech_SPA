 ...
 * This is kept for backward compatibility with any code that might expect
 * voices to be organized by engine
 ...
 * @returns {Array} Array of initial active voices
 */
const getInitialActiveVoices = () => {
...
export const initialPersistentState = {
  ...
  settings: {
    speechEngine: 'gtts',
    defaultActiveVoices: getDefaultVoices(),
    customVoices: {},
    activeVoices: getInitialActiveVoices(),
    defaultVoice: {
      engine: 'gtts',
      voiceId: getDefaultVoices().gtts[0].id, // e.g., 'en-com'
      id: getDefaultVoices().gtts[0].id,      // Add id for compatibility
      name: getDefaultVoices().gtts[0].name,  // Add name
      language: getDefaultVoices().gtts[0].language, // Add language
    },
    elevenLabsApiKeys: [],
    awsPollyCredentials: [],
...
export const initialSessionState = {
  ...
  lastAudioInputSelection: { audioId: null, audioCategory: 'sound_effect' }, // Add this
};